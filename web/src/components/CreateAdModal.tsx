          ...
          <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
            <div className='flex flex-col gap-2'>
              ...
              <select
                ...
                name="game"
                defaultValue=""
                className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zic-500 appearance-none'
              >
            ...
            <div className='grid grid-cols-2 gap-6'>
              <div className='flex flex-col gap-2'>
                <label htmlFor="years className='font-semibold'Playing">Joga há quantos anos?</label>
                <Input id="yearsPlaying" name="yearsPlaying" type="text" placeholder="Tudo bem ser ZERO" />
              </div>
              <div className='flex flex-col gap-2'>
                <label htmlFor="disco className='font-semibold'rd">Qual seu Discord?</label>
